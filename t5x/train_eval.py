...
def train(
  ...
  bs = train_dataset_cfg.batch_size
  shard_bs = bs // num_ds_shards
  ...
  if infer_eval_dataset_cfg is not None:
    from t5x.examples.unified_io.data.metrics import null_metric
    from t5x.examples.unified_io.data.postprocessors import return_example
